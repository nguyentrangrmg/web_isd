              ...
              <div class="info-content">
                ...
                <div class="row">
                    ...
                    <?php foreach ($nganh_nghe_list as $index => $nganh_nghe): ?>
                        <div class="field-name" style="margin-left:30px">Ngành nghề <?php echo $index + 1; ?></div>
                    <?php endforeach; ?>
                </div>
              <div class="information" style="text-align: right; margin:0;padding:0">
                  <div class="row" style="text-align:right;">
                      ...
                      <?php foreach ($nganh_nghe_list as $nganh_nghe): ?>
                          <div class="sub-field" style="margin-top:10px; height:26.78px"><?php echo $nganh_nghe; ?></div>
                      <?php endforeach; ?>
                  </div>
              </div>
            </div>
                ...
                <div class="info-item" style="padding: top 0px;">
                  <div class="row">
                      ...
                      <?php foreach ($noi_lam_viec_list as $index => $noi_lam_viec): ?>
                          <div class="field-name" style="margin-left:30px">Nơi làm việc <?php echo $index + 1; ?></div>
                      <?php endforeach; ?>
                  </div>
                  <div class="information" style="text-align: right; margin:0;padding:0">
                      <div class="row" style="text-align:right;">
                          ...
                          <?php foreach ($noi_lam_viec_list as $noi_lam_viec): ?>
                              <div class="sub-field" style="margin-top:10px; height:26.78px"><?php echo $noi_lam_viec; ?></div>
                          <?php endforeach; ?>
                      </div>
                  </div>
              </div>
        ...
        <div class="background-container">
          <div class="info-container expanded" id="info-container-4">
            ...
            <div class="info-content-wrapper">
              <div class="info-content">
                <div class="info-item">
                  <div class="field-name"><td><?php echo $row['ghi_chu_e']; ?></td></div>
                </div>
              </div>
            </div>
          </div>
