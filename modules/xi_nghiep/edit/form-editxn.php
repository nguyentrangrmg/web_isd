...
<div class="container">
  <div class="add-form">
    ...
    <a style="font-style: italic;margin-left:10px;font-size:12px"> Vui lòng không để trống các trường thông tin bắt buộc ( <strong style="color: red;">*</strong> ) </a>
    <br>
    <br>
    <form action="modules/xi_nghiep/edit/edit_xn.php" method="POST" enctype="multipart/form-data" onsubmit="return collectData()">
      <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="xi_nghiep" name="xi_nghiep" maxlength="50" value="<?php echo $row['xi_nghiep'] ?>" required>
                ...
                <div class="col-md-4">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="ten_giam_doc" name="ten_giam_doc" value="<?php echo $row['ten_giam_doc'] ?>" maxlength="50" required />
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="tel" class="form-control" id="sdt" name="sdt" maxlength="10" pattern="[0-9]+" value="<?php echo $row['sdt_xn'] ?>"  required title="Vui lòng điền đúng định dạng số!"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <code>*</code></label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="dia_chi_xn" name="dia_chi_xn" maxlength="255" value="<?php echo $row['dia_chi_xn'] ?>" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="nghiep_doan" name="nghiep_doan" value="<?php echo $row['nghiep_doan'] ?>"  maxlength="20" required>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        ?>
                            ...
                            <div class="col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nganh_nghe[]" value="<?php echo $nganh_nghe; ?>">
                      ...
                      <?php
                        ...
                        ?>
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="noi_lam_viec[]" value="<?php echo $noi_lam_viec; ?>">
                                        <div class="input-group-append">
                                            <button class="btn btn-danger" type="button" onclick="removeInput(this)">Xóa</button>
                                        </div>
                                    </div>
