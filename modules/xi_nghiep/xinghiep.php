    ...
    <div>
        <div class="loai_xn">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" href="#" style="text-decoration: none;color:black">Thực tập sinh số
                        1</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" style="text-decoration: none;color:black">Thực tập sinh số
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" style="text-decoration: none;color:black">Kỹ năng đặc
                        định</a>
                </li>
            </ul>
        </div>
                    ...
                    <table class="table table-hover table-stripe">
                        ...
                        ?>
                            <tr id="box<?php echo $row['mdn'] ?>">
                                <td><input type="checkbox" id="<?php echo $row['mdn'] ?>" name="checkbox[]" value="<?php echo $row['mdn'] ?>" /></td>
                                <td style="white-space: nowrap;"><a href="index.php?action=view&mxn=<?php echo $row['mdn'] ?>" class="view" style="text-decoration: none;color:black">
                        ...
                        if ($pages > 0) { ?>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination d-flex justify-content-center">
                                    ...
                                    if ($end_page < $pages) {
                                        ?>
                                        <li class="page-item"><a class="page-link" href="?pageo=<?php echo $pages; ?>&chucnang=xinghiep"><?php echo $pages; ?></a>
                                        </li>
                                    <?php
                                    }
                                    ?>
    ...
    <script>
        ...
        function delete_all() {
            if (jQuery('input[type=checkbox]:checked').length > 0) {
                var check = confirm(
                    "Bạn chắc chắn muốn xóa xí nghiệp này?(Xí nghiệp sẽ được lưu trữ trong thùng rác 30 ngày)");
                if (check == true) {
                    jQuery.ajax({
