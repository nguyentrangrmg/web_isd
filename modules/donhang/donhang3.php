...
where type_hv='3' ORDER BY CONCAT(SUBSTRING(mdh, 3, 2), SUBSTRING(mdh, -3)) ASC 
;");
    ?>
    <!-- Menu -->
    <div class="loai_hv">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="?typedh=3" style="text-decoration: none;color:black" >Thực tập sinh số 3</a>
            </li>
            <li class="nav-item">
