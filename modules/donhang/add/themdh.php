                                           ...
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-12">
                                                           <input type="text" class="form-control" id="nghiep_doan" name="nghiep_doan" maxlength="50" required />
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-12">
                                                       <input type="date" class="form-control" id="du_kien_tt" name="du_kien_tt" maxlength="50" required>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row"><label class="col-sm-9">Ngày thi
                                                           tuyển<code>*</code></label>
                                                       <div class="col-sm-12">
                                                       <input type="date" class="form-control" id="ngay_tt" name="ngay_tt" maxlength="50" required>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                          ...
                                          ?>
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row">
                                                       ...
                                                       <select class="form-select" id="hinh_thuc_tt" name="hinh_thuc_tt" onchange="showOtherInput()">
                                                        ...
                                                        <option value="other" <?php echo $status == 'other' ? 'selected' : ''; ?>>Khác</option>
                                                       </select>
                                                       </div>
                                               ...
                                               <div class="col-md-4">
                                                   <div class="form-group row">
                                                       <div class="col-sm-12" id="other-input" style="display: <?php echo $status == 'other' ? 'block' : 'none'; ?>;">
                                                       <label for="otherText" class="col-sm-9">Vui lòng mô tả chi tiết:<code>*</code> </label>
                                                       <input type="text" class="form-control" id="otherText" name="otherText" value="<?php echo htmlspecialchars($otherText); ?>">
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           ...
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row"><label class="col-sm-9">Ngày xuất
                                                       ...
                                                       <div class="col-sm-12">
                                                       <input type="date" class="form-control" id="ngay_xc" name="ngay_xc" maxlength="50">
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-md-4">
                                                   <div class="form-group row"><label class="col-sm-9">Ngày về
                                                           nước</label>
                                                       <div class="col-sm-12">
                                                       <input type="date" class="form-control" id="ngay_vn" name="ngay_vn" maxlength="50">
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           ...
                                           <div class="m-col">
                                               ...
                                               <div class="row">
                                                   <div class="col-md-2">
                                                       <div class="form-group row">
                                                           <div class="col-sm-8">
                                                               <input type="text" class="form-control" id="so_luong_tuyen" name="so_luong_tuyen" required />
                                                           </div>
                                                       </div>
                                                   </div>
                                                   <div class="col-md-5">
                                                   ...
                                                   <div class="col-md-4">
                                                       <div class="form-group row">
                                                           ...
                                                           <div class="col-sm-4">
                                                               <input type="text" class="form-control" id="tuoi_nam1" name="tuoi_nam1"/>
                                                           </div>
                                                           <div class="col-md-5">
                                                               <div class="row">
                                                                   ...
                                                                   <div class="col-sm-9">
                                                                       <input type="text" class="form-control" id="tuoi_nam2" name="tuoi_nam2"
                                                                           required />
                                                                   </div>
                                                               </div>
                                                           </div>
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col-md-4" style="margin-left: 25px;">
                                                   <div class="form-group row">
                                                       <label class="col-sm-3 col-form-label ">Độ tuổi</label>
                                                       <div class="col-sm-4">
                                                           <input type="text" class="form-control" id="tuoi_nu1" name="tuoi_nu1"/>
                                                       </div>
                                                       <div class="col-md-5">
                                                           <div class="row">
                                                               <div class="col-sm-3 col-form-label">
                                           ...
                                           <div class="row">
                                               <div class="col-md-8">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-8">
                                                           <input type="text" class="form-control" id="luong_co_ban" name="luong_co_ban"/>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-md-8">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-8">
                                                           <input type="text" class="form-control" id="luong_thuc_te" name="luong_thuc_te"/>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-md-8">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-12">
                                                           <input type="text" class="form-control" id="che_do_phu_cap" name="che_do_phu_cap"/>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
                                           ...
                                           <div class="row">
                                               <div class="col-md-8">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-4">
                                                           <input type="text" class="form-control" id="lv_theo_ngay" name="lv_theo_ngay"/>
                                                       </div>
                                                       <div class="col-md-4">
                                           ...
                                           <div class="row">
                                               <div class="col-md-8">
                                                   <div class="form-group row">
                                                       ...
                                                       <div class="col-sm-4">
                                                           <input type="text" class="form-control" id="lv_theo_tuan" name="lv_theo_tuan"/>
                                                       </div>
                                                       <div class="col-md-4">
                                                           <label class="col-sm-6 col-form-label">tiếng/ngày</label>
                                                       </div>
