...
if (isset($_GET['search_dh'])) {
    ...
    $count_query = "SELECT COUNT(*) AS total FROM jporder WHERE type_hv='dd'";
    $count_result = executeQuery($mysqli, $count_query);
    $count_row = mysqli_fetch_assoc($count_result);
    $rs = $count_row['total'];
}
...
<div>
    <div class="function" style="text-align: right;">
        ...
        <form action="" method="GET" style="display: inline-block;">
            ...
            <input type="hidden" name="type_dh" value="dd">
            <button type="submit" name="search_dh" class="search-button"><i
            ...
            <form method="post" id="frm">
                <table class="table table-hover table-stripe">
                    ...
                    <tr id="box<?php echo $row['mdh'] ?>">
                        <td><input type="checkbox" id="<?php echo $row['mdh'] ?>" name="checkbox[]"
                                value="<?php echo $row['mdh'] ?>" /></td>
                        ...
                        <td>
                            <div style="display:flex" class="action-buttons">
                                ...
                                <a href="index.php?action=view&mdh=<?php echo $row['mdh']; ?>" class="view"
        ...
        <div class="pagination">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination d-flex justify-content-center">
                    <li class="page-item">
                        <a class="page-link"
                            href="?pageo=<?php echo max(1, $current_page - 1); ?>&typedh=<?php echo $typedh; ?>"
                            aria-label="Previous">
                    ...
                    <li class="page-item"><a class="page-link"
                            href="?pageo=<?php echo $i; ?>&typedh=<?php echo $typedh; ?>"><?php echo $i; ?></a></li>
                    <?php
                            } else { ?>
                    <li class="current-page page-item"><a style="color:white;background:#374375;" class="page-link"
                            href="?pageo=<?php echo $i; ?>&typedh=<?php echo $typedh; ?>"><?php echo $i; ?></a></li>
                    <?php
                            }
                        }
                        ...
                        if ($end_page < $pages) {
                            ?>
                    <li class="page-item"><a class="page-link"
                            href="?pageo=<?php echo $pages; ?>&typedh=<?php echo $typedh; ?>"><?php echo $pages; ?></a>
                    </li>
                    <?php
                        }
                        ?>
                    <li class="page-item">
                        <a class="page-link"
                            href="?pageo=<?php echo min($pages, $current_page + 1); ?>&typedh=<?php echo $typedh; ?>"
                            aria-label="Next">
