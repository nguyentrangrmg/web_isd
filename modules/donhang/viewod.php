...
<body>
    ...
    <div class="loai_hv">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link <?php if ($type_hv == 1) echo "active"; ?>" style="text-decoration: none;color:black"
                    href="#">Thực tập sinh số 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php if ($type_hv == 3) echo "active"; ?>" style="text-decoration: none;color:black"
                    href="#">Thực tập sinh số 3</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php if ($type_hv == 'dd') echo "active"; ?>"
                    style="text-decoration: none;color:black" href="#">Kỹ năng đặc định</a>
            </li>
        </ul>
    </div>
                    ...
                    <div class="info-content-wrapper">
                        <div class="info-content">
                                ...
                                <div class="information" style="text-align: right; margin:0;padding:0">
                                    <div class="row" style="text-align:right;">
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['xi_nghiep'] ?></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['ten_giam_doc'] ?></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['sdt_xn'] ?></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['dia_chi_xn'] ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <div class="information"><?php echo date('d/m/Y', strtotime($row['du_kien_tt'])) ?>
                                </div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item" style="padding: top 0px;">
                                ...
                                <div class="information" style="text-align: right; margin:0;padding:0">
                                    <div class="row" style="text-align:right;">
                                        ...
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">SL:
                                            <?php echo $row['sl_nam'] ?>; từ <?php echo $row['do_tuoi_nam'] ?> tuổi
                                        </div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">SL:
                                            <?php echo $row['sl_nu'] ?>; từ <?php echo $row['do_tuoi_nu'] ?> tuổi</div>
                                    </div>
                                </div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item" style="padding: top 0px;">
                                ...
                                <div class="information" style="text-align: right; margin:0;padding:0">
                                    <div class="row" style="text-align:right;">
                                        <div class="sub-field" style="margin-top:10px; height:26.78px"></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['luong_co_ban'] ?></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['luong_thuc_te'] ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item" style="padding: top 0px;">
                                ...
                                <div class="information" style="text-align: right; margin:0;padding:0">
                                    <div class="row" style="text-align:right;">
                                        <div class="sub-field" style="margin-top:10px; height:26.78px"></div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['lv_theo_ngay'] ?> tiếng/ngày</div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['lv_theo_tuan'] ?> tiếng/tuần</div>
                                        <div class="sub-field" style="margin-top:10px; height:26.78px">
                                            <?php echo $row['nghi'] ?> tiếng/ngày</div>
                                    </div>
                                </div>
                            </div>
                        </div>
