<body>
    ...
    //   <li class="nav-item">
    //       <a class="nav-link" data-toggle="tab" href="?type=1">Thực
    //           tập sinh số 1</a>
    //   </li>
    //   <li class="nav-item">
    //       <a class="nav-link" data-toggle="tab" href="?type=3">Thực
    //           tập sinh số 3</a>
    //   </li>
    //   <li class="nav-item">
    //       <a class="nav-link" data-toggle="tab" href="?type=dd">Kỹ
    //           năng mặc định</a>
    //   </li>
    // </ul>
    ...
    <div class="loai_hv">
        <ul class="nav nav-tabs tab-transparent">
            <li class="nav-item">
                <a class="nav-link active" href="?type=1" style="text-decoration: none;color:black">Thực tập
                    sinh số 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?type=3" style="text-decoration: none;color:black">Thực tập
                    sinh số 3</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?type=dd" style="text-decoration: none;color:black">Kỹ năng
                    đặc định</a>
            </li>
        </ul>
    </div>
                ...
                <table class="table table-hover table-stripe">
                    ...
                    ?>
                        <tr id="box<?php echo $row['mhv'] ?>">
                            ...
                            <td style="white-space: nowrap;"><a href="index.php?action=view&mhv=<?php echo $row['mhv']; ?>" class="view" style="text-decoration: none;color:black">
                    ...
                    if ($pages > 0) { ?>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination d-flex justify-content-center">
                                ...
                                if ($end_page < $pages) {
                                    ?>
                                    <li class="page-item"><a class="page-link" href="?pageo=<?php echo $pages; ?>&type=<?php echo $type; ?>"><?php echo $pages; ?></a>
                                    </li>
                                <?php
                                }
                                ?>
