            ...
            <form action="modules/hocvien/add/add.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group row ">
                                        <label for="file_anh" class="col-sm-9">Ảnh học viên <code>*</code> <span class="card-description" style="font-style: italic;">(Ảnh 4x6, kích
                                                thước tối đa
                                                50MB)</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="tel" id="sdt_bl" name="sdt_bl" class="form-control" pattern="[0-9]+" required />
                                            <!-- require number -->
                                        </div>
                                    </div>
                                </div>
                ...
                ?>
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select" id="mdh" name="mdh">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['mdh'] ?>; <?php echo $row['ten_dh'] ?>">
                                                            <?php echo $row['mdh'] ?>: <?php echo $row['ten_dh'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="col-14 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h5 style="font-weight: bold;">Ghi chú</h5>
