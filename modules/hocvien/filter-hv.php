...
<div class="pagination-container">
    <div class="pagination">
        <?php
                $type = isset($_GET['filter']) ? $_GET['filter'] : 'hocvien';
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination d-flex justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="?pageo=<?php echo max(1, $current_page - 1); ?>&filter=<?php echo $type; ?>" aria-label="Previous">
                        ...
                        if ($start_page > 1) {
                            ?>
                            <li class="page-item"><a class="page-link" href="?pageo=1&filter=<?php echo $type; ?>">1</a></li>
                            <?php
                            if ($start_page > 2) {
                        ...
                        for ($i = $start_page; $i <= $end_page; $i++) {  
                            if ($i != $current_page) {
                                ?>
                                <li class="page-item"><a class="page-link" href="?pageo=<?php echo $i; ?>&filter=<?php echo $type; ?>"><?php echo $i; ?></a></li>
                                <?php
                            } else { ?>
                                <li class="current-page page-item"><a style="color:white;background:#374375;" class="page-link" href="?pageo=<?php echo $i; ?>&filter=<?php echo $type; ?>"><?php echo $i; ?></a></li>
                            <?php 
                            }
                        }
                        ...
                        if ($end_page < $pages) {
                            ?>
                            <li class="page-item"><a class="page-link" href="?pageo=<?php echo $pages; ?>&filter=<?php echo $type; ?>"><?php echo $pages; ?></a></li>
                            <?php
                        }
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="?pageo=<?php echo min($pages, $current_page + 1); ?>&filter=<?php echo $type; ?>" aria-label="Next">
