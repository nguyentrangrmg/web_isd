          ...
          <form id="formAuthentication" class="mb-3" action="login.php" method="post">
            <div class="mb-3">
              ...
              <input type="text" value="<?php if (isset($_COOKIE['user'])) {
                                          echo $_COOKIE['user'];
                                        } ?>" class="form-control" id="email" name="uname" placeholder="Nhập tài khoản người dùng" autofocus maxlength="20">
            </div>
            <div class="mb-3 form-password-toggle">
              ...
              <div class="input-group input-group-merge">
                <input type="password" id="password" value="<?php if (isset($_COOKIE['pass'])) {
                                                              echo $_COOKIE['pass'];
                                                            } ?>" class="form-control" name="psw" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" maxlength="20">
              </div>
            </div>
            <div class="d-flex justify-content-between align-items-center mb-4">
              <div class="form-check">
                <input class="form-check-input" name="remember" type="checkbox" <?php if (isset($_COOKIE['user'])) {
                                                                                  echo 'checked';
                                                                                } ?> id="formRemember" />
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 extra-spacing">
            </div>
            <?php
