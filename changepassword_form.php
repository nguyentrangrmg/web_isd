        ...
        <div class="content-wrapper">
            ...
            <form id="formAuthentication" class="mb-3" action="#" method="post">
                <div class="setting" style="margin-left: 50px;">
                    <h4 class="text-dark font-weight-bold mb-3">Đổi mật khẩu</h4>
                    <p class="text-muted mb-4">Mật khẩu của bạn phải có ít nhất 6 ký tự và không vượt quá 20 ký tự</p>
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group rounded">
                                        <input type="password" class="form-control" name="currentPassword"
                                            id="currentPassword" maxlength="20" required />
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group rounded">
                                        <input type="password" class="form-control" name="confirmNewPassword"
                                            id="confirmNewPassword" maxlength="20" required />
                                        <span class="password-toggle-icon"
                                            onclick="togglePasswordVisibility('confirmNewPassword')">
                                            <i class="fa fa-eye-slash" id="confirmNewPasswordIcon"></i>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            ...
                            <a href="?chucnang=dashboard" class="btn btn-light ml-3">Huỷ</a>
                        </div>
                    </div>
                    <!-- <div class="d-flex justify-content-between">
                    <button type="submit" class="btn btn-primary">Đổi mật khẩu</button>
                    <a href="?chucnang=dashboard" class="btn btn-light">Huỷ</a>
                </div> -->
